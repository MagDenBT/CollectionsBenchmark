...
// //    }
//    lateinit var rvModel: StatViewModel
//
//    @Inject
...
//            setContent {
//                AppTheme {
//                    ViewPagerFragmentComposeScreen(
//                        { amount ->
//                            rvModel.startBenchmark(
//                                sharedCollSizeVM.get().collectionSize,
//                                amount,
//                            )
//                        },
//                        rvModel.statModelsLD.toMutableStateList(),
...
// //        binding!!.inElementsAmount.setOnEditorActionListener(
